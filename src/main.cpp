...
int main( int argc, const char** argv ) {
  ...
  //  only shows the face detection window  
  ...
  // -------------------------------------
  // do not show the raw video captured by webcam
  // -------------------------------------
...
void findEyes(cv::Mat frame_gray, cv::Rect face) {
  ...
  std::cout << "right x: " << rightPupil.x << "  ";
  std::cout << "right y: " << rightPupil.y << std::endl;
  std::cout << "left x: " <<  leftPupil.x << "  ";
  std::cout << "left y: " << leftPupil.y << std::endl;
  ...
  if(time_counter < 10)
  {
    std::cout << "time: " << time_counter << std::endl;
    if(time_counter < 3){
      x_o=x_center=rightPupil.x;
      y_o=y_center=rightPupil.y;
    }
    else {
      x_o=x_center;
      y_o=y_center;
      x_center=(rightPupil.x+x_center)/2;
      y_center=(rightPupil.y+y_center)/2;
    }
